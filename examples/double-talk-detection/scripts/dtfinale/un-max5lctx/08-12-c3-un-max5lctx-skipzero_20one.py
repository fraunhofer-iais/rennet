...
trn_class_subsampling = (0, 0.2)
val_class_subsampling = (0, )
...
starting_model_fp = os.path.join(activity_dir, "..", "08-11-c3-un-max5lctx-skipzero_20one", "w.079-0.409-0.838.h5")
